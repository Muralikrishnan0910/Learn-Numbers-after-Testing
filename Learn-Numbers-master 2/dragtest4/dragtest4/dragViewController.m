...
#define DRAGGABLE_LOCATION_WIDTH  ((OBJECT_WIDTH  * 5) + (MARGIN_HORIZONTAL * 6))
#define DRAGGABLE_LOCATION_HEIGHT ((OBJECT_HEIGHT * 4) + (MARGIN_VERTICAL   * 6))
...
@synthesize topWrapper;
@synthesize bottomWrapper;
...
- (void) setupDraggableLocations {
    ...
    SEDraggableLocation *draggableLocationTop = [[SEDraggableLocation alloc] initWithFrame:CGRectMake(locationXCoord, 17.0f, DRAGGABLE_LOCATION_WIDTH, DRAGGABLE_LOCATION_HEIGHT)];
...
//    topWrapper    = [[UIView alloc] initWithFrame: draggableLocationTop.frame];
//    bottomWrapper = [[UIView alloc] initWithFrame: draggableLocationBottom.frame];
